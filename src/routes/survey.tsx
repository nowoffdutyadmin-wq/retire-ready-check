...
import { DisclaimerBox, SiteShell } from "../components/site-shell";
        ...
        <div className="sticky top-0 z-30" style={{ backgroundColor: T.bg }}>
          <div className="mx-auto max-w-2xl px-5 pt-4 pb-3">
            <div className="flex items-center justify-between mb-2">
              <button
                onClick={back}
                className="focus-ring text-[16px] underline-offset-4 hover:underline"
                style={{ color: T.muted, minHeight: 44, paddingRight: 8 }}
              >
                ← Back
              </button>
              <div className="text-[16px] tracking-[0.18em]" style={{ color: T.muted }}>
                NOW OFF DUTY
              </div>
            </div>
...
function ScoredQuestion({
  ...
  return (
    <section className="pt-4">
      <div className="text-[16px] tracking-[0.18em] mb-4" style={{ color: T.muted }}>
      ...
      <div className="mt-10">
        ...
        <div className="mt-4 flex justify-between text-[16px]" style={{ color: T.inkSoft }}>
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 flex flex-col items-center gap-3 text-center" style={{ minHeight: 110 }}>
        <div style={{ fontSize: 16, color: T.muted }}>Reading your answers…</div>
        {step >= 1 && <div style={{ fontSize: 16, color: T.muted }}>Matching your pattern…</div>}
        {step >= 2 && (
  ...
  return (
    <section className="pt-2 pb-16">
      ...
      <div className="text-center pt-6">
        <div className="text-[16px] tracking-[0.22em]" style={{ color: T.sageDeep }}>
          YOUR OFF-DUTY SCORE
        </div>
        <div
        ...
        >
          {!videoPlaying ? (
            ...
            >
              ...
              <div
                className="absolute bottom-4 left-5 right-5 text-left text-[16px]"
            ...
            >
              <div>
                <div className="text-[16px]" style={{ opacity: 0.7 }}>
                  Video player
                </div>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 16, color: T.muted, fontFamily: "Inter, sans-serif" }}>
            one-time
          </div>
        </div>
        ...
        >
          ...
          <div>
            <div className="text-[16px] font-semibold" style={{ color: T.ink }}>
